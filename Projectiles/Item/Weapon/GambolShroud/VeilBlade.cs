...
{
	public class VeilBlade : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Veil Blade");
		...
		public override void AI()
        {
			...
			if (itemType != ItemType<Items.Weapons.GambolVeil>() && itemType != ItemType<Items.Weapons.GambolShadeS>()) Projectile.Kill();
