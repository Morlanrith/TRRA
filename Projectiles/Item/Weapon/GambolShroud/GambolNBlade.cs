...
{
	public class GambolNBlade : ModProjectile
	{
        ...
        {
			if (Main.player[Projectile.owner].HeldItem.type != ItemType<Items.Weapons.GambolShroud.Nightmare.GambolShroudNS>()) Projectile.Kill();
