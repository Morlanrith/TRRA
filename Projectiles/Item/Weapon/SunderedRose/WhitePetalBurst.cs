	...
	public class WhitePetalBurst : ModProjectile
	{
        ...
        public override void AI()
		{
            ...
            if (Main.myPlayer == Projectile.owner)
			{
				...
				if (!(player.CCed || player.dead || player.mount.Active || player.grappling[0] > -1 || PlayerInput.Triggers.JustPressed.Grapple) && player.HeldItem.type == ItemType<Items.Weapons.SunderedRose.SunderedRoseA>())
				{
