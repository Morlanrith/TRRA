...
{
	public class SunderedAxeSlash : ModProjectile
	{
		...
		{
            Projectile.alpha = 200 - (int)(Projectile.timeLeft * (100.0f / 45));
            ...
            {
                Dust dust = Dust.NewDustPerfect(position3, DustType<WhiteRosePetal>(), null, 150, default, 1.4f);
