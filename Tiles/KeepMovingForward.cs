...
{
    public class KeepMovingForward : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 50, 34, ModContent.ItemType<Items.Placeable.KeepMovingForward>());
		}
	}
}
