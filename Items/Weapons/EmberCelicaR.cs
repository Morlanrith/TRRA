	...
	public class EmberCelicaR : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			if (player.altFunctionUse == 2)
			{
				...
				item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/Weapon/EmberCelica/RocketTriple");
			}
			else item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/Weapon/EmberCelica/RocketSingle");
		...
		{		
			...
			if (player.altFunctionUse == 2) type = ProjectileType<Projectiles.Item.Weapon.EmberCelica.TripEmberRocket>();
			else type = ProjectileType<Projectiles.Item.Weapon.EmberCelica.EmberRocket>();
			return true;
		}
